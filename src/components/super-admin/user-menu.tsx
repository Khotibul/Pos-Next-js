  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end">
        ...
        <DropdownMenuSeparator />
        <DropdownMenuItem onSelect={() => (window.location.href = "/super-admin")}>Dashboard SaaS</DropdownMenuItem>
        <DropdownMenuItem onSelect={() => (window.location.href = "/dashboard")}>Dashboard Tenant</DropdownMenuItem>
        <DropdownMenuSeparator />
