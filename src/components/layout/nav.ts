...
export const NAV_ITEMS = [
  ...
  { href: "/receivables", label: "Piutang", icon: HandCoins, section: "main", permission: PERMISSIONS.receivables_read },
  { href: "/payables", label: "Utang", icon: Receipt, section: "main", permission: PERMISSIONS.payables_read },
