...
export const DEFAULT_ROLE_PERMISSION_MATRIX: Record<(typeof DEFAULT_ROLES)[number], string[]> = {
  ...
  ACCOUNTANT: ["dashboard.read", "branches.read", "sales.read", "transactions.shift.read", "transactions.shift.export", "reports.read", "products.read", "customers.read", "suppliers.read", "billing.read"],
  BRANCH_MANAGER: [
    "dashboard.read",
    "sales.read",
    "sales.write",
