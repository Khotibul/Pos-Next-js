...
export const RECEIPT_DENSITY: Record<"compact" | "standard" | "detailed", ReceiptDensity> = {
  compact: { key: "compact", paddingMm: 2, sectionGapPx: 3, itemGapPx: 1, lineHeight: 1.18, footerFeedLines: 0 },
  standard: { key: "standard", paddingMm: 3, sectionGapPx: 4, itemGapPx: 2, lineHeight: 1.25, footerFeedLines: 0 },
  detailed: { key: "detailed", paddingMm: 4, sectionGapPx: 4, itemGapPx: 3, lineHeight: 1.32, footerFeedLines: 0 },
};
